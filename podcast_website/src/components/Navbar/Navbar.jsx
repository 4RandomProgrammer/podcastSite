...
const Navbar = () => {
    return (
        <div className="bg-yellow-500 w-full flex justify-between p-4 font-inter">
            <div className="text-black font-semibold h-13"><img src="./src/assets/Logo.png" alt="" srcset="" className="h-14" /></div>
